...
async function submitfunction(event){
    ...
    const res = await axios.post("https://crudcrud.com/api/de97c5fc86174cf1bb7320a8650ee4ae/order",tobj)
    //console.log(res)
    printinfo(res)
}
...
async function reloadedpage(){
    ...
    const newobj = await axios.get("https://crudcrud.com/api/de97c5fc86174cf1bb7320a8650ee4ae/order")
...
function deleteuserinfo(id){
    let url='https://crudcrud.com/api/de97c5fc86174cf1bb7320a8650ee4ae/order'
    url=url+'/'+id.toString()
    alert(url)
    axios.delete(url);
